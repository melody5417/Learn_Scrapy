...
START_URL = (
    "https://search.51job.com/list/010000%252C020000%252C030200,000000,0000,00,9,99,Python,2,{}.html?lang=c&stype=1&postchannel=0000&workyear=99&cotype=99&degreefrom=99&jobterm=99&companysize=99&lonlat=0%2C0&radius=-1&ord_field=0&confirmdate=9&fromType=&dibiaoid=0&address=&line=&specialarea=00&from=&welfare="
)
...
class JobSpider:
    ...
    def post_require(self):
        ...
        while True:
            ...
            logger.info("开始爬取第 {} 条岗位详情 {}".format(self.count, url))
